...
public class LinedEditText extends LineNumberTextView {
    ...
    public LinedEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(LinedEditText.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(LinedEditText.class.getName());
    }
