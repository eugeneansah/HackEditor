...
import com.hackathon.hackmsit.utilities.LinedEditText;
...
public class NotePlainEditorActivity extends AppCompatActivity {
    ...
    private LinedEditText mCodeEditText;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCodeEditText = (LinedEditText) findViewById(R.id.autoCompleteTextView);
        ...
        mCodeEditText.setLineNumberColor(Color.GRAY);
        mCodeEditText.setLineNumberSize(20);
